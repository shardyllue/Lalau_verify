...
band_text = """
Уважаемые подписчики премиум-канала "lalau", для удобства знакомства с другими участниками мы создали список анкет участников проекта, которые ищут знакомства.Напоминаем, что "lalau" категорически против услуг проституции, порнографии и всему, что запрещено Уголовным кодексом Российской Федерации.
"""
